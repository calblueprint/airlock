...
function Base(airtable, baseId) {
    ...
    this._id = baseId;
    this.register = callbackToPromise(this._register, this);
}
...
Base.prototype._register = function({username, password}, done) {
    runAction(this, 'post', '/register', {}, {username, password}, function(err, data) {
        done(err, data);
    });
};
...
Base.createFunctor = function(airtable, baseId) {
    ...
    forEach(['table', 'runAction', 'getId', 'register'], function(baseMethod) {
