...
function Base(airtable, baseId) {
    ...
    this._id = baseId;
    this._user = this.getLocalStorage('user');
...
Base.prototype.setLocalStorage = function(key, value) {
    localStorage.setItem(key, JSON.stringify(value));
};

Base.prototype.getLocalStorage = function(key) {
...
Base.createFunctor = function(airtable, baseId) {
    ...
    forEach(['table', 'runAction', 'getId', 'register', 'login', 'logout', 'getUser', 'getUsername', 'getToken', 'setLocalStorage', 'getLocalStorage'], function(baseMethod) {
