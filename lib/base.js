...
Base.prototype.register = function({username, password, fields}, done) {
    ...
    runAction(this, 'post', '/__DANGEROUSLY__USE__TABLE__TO__LET__USERS__REGISTER', {}, {username, password, fields}, (err, data) => {
        // this._user = data;
        // err = err || this._setLocalStorage('user', data);
        done(err, data);
    });
};
...
Base.prototype.login = function({username, password}, done) {
    ...
    runAction(this, 'post', '/__DANGEROUSLY__USE__TABLE__TO__LET__USERS__LOGIN', {}, {username, password}, (err, data) => {
        this._user = {
            user: {
...
Base.prototype.logout = function(done) {
    ...
    this._user = null;
    done(this._setLocalStorage('user', null), {});
};
